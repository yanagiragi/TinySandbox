...
namespace TinySandbox
{
	...
	Texture::Texture(const char* filename, TextureType _textureType, bool _isHDR, bool _isCubemap, int isPrefilter, int _cubemapResolution, int _convCubemapResolution, int _prefilterCubemapResolution, int _mipsLevel) : m_filename(filename)
	{
		m_textureType = _textureType;
		m_api = GraphicsAPI::GetAPI();
		isHighDynamicRange = _isHDR;
